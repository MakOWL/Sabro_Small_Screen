...
enum device_data{
  ...
  SMALL_SCREEN_AUTHENTICATOR = 1184005015U,
...
enum messages{ SEND_STRUCT_DATE_AND_TIME = 1, SEND_STRUCT_PAIRING_CONFIRMATION = 2 };
...
enum esp_now_messages{
  ...
  ESPNOW_MESSAGE_TYPE_PRICE_MODE_REALTIME_DATA,
  ESPNOW_MESSAGE_TYPE_SINGLE_PHASE_METER_DATA,
  ESPNOW_MESSAGE_TYPE_THREE_PHASE_METER_DATA,
  ESPNOW_MESSAGE_TYPE_CHART_DAILY_OFF_PEAK_ARRAY,
  ESPNOW_MESSAGE_TYPE_CHART_DAILY_PEAK_ARRAY,
  ESPNOW_MESSAGE_TYPE_CHART_MONTHLY_OFF_PEAK_ARRAY,
  ESPNOW_MESSAGE_TYPE_CHART_MONTHLY_PEAK_ARRAY,
  ESPNOW_MESSAGE_TYPE_SET_TEMPERATURE_MODE,
  ESPNOW_MESSAGE_TYPE_SET_PRICE_MODE,
  ESPNOW_MESSAGE_TYPE_START_OTA_WEB_INPUT,
...
extern uint8_t available_connections_macs[MAXIMUM_AVAILABLE_DEVICES_COUNT][MAC_ADDRESS_ARRAY_SIZE];
